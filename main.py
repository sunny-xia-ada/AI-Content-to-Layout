...
# --- Style System (AURA CORE) ---
STYLES = {
    "card": "width: 100%; max-width: 450px; margin: 0 auto; background: #FFFFFF; padding: 40px 25px; border-radius: 20px; box-shadow: 0 10px 40px rgba(0,0,0,0.05); font-family: 'Helvetica Neue', Arial, sans-serif;",
